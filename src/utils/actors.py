...
class ActorStats():
    ...
    def cluster_mean_revenue(self, cluster):
        """
        ...
        """
        revenues = [self.actor_mean_revenue(actor_id) for actor_id in cluster.actor_ids]
        return np.nanmean(revenues)


    def cluster_movies(self, cluster):
        """
        ...
        movie_ids = {movie_id for actor_id in cluster.actor_ids for movie_id in self.actor_movie_ids(actor_id)}
        return self.movies[self.movies["WikipediaId"].isin(movie_ids)]

    
    def cluster_total_revenue(self, cluster):
        """
        ...
        """
        return self.cluster_movies(cluster)["Revenue"].sum()


    def cluster_genders(self, cluster, plot=False):
        """
        ...
        actors = self.characters[self.characters["FreebaseActorId"].isin(cluster.actor_ids)].drop_duplicates(subset="FreebaseActorId")
    ...
    def cluster_ages(self, cluster, plot=False):
        """
        ...
        """
        roles = self.characters[self.characters["FreebaseActorId"].isin(cluster.actor_ids)]
    ...
    def cluster_genres(self, cluster, plot=False):
        """
        ...
        """
        genres = self.cluster_movies(cluster)["Genres"].apply(
